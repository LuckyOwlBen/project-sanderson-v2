import { BonusType } from '../talents/talentEnums/bonusType';
import { InventoryItem, ItemType, ItemRarity, StartingKit, Mount, Mount } from './inventoryItem';
...
export const MOUNT_ITEMS: Mount[] = [
  {
    id: 'chull',
    name: 'Chull',
    type: 'mount',
