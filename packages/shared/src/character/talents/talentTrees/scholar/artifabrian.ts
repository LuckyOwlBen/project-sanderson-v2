  ...
  nodes: [
    {
      ...
      bonuses: [
        {
          ...
          target: 'crafting',
          value: 2,
          condition: 'Opportunity range expansion',
        },
      ],
      expertiseGrants: [
      ...
      otherEffects: [
        'Gain amplifying painrial, numbing painrial, or spanreeds+emotion bracelet',
        'Material costs halved',
      ],
    },
    {
      ...
      description:
        'When you acquire this talent, you gain a specialist expertise in Fabrial Crafting. Additionally, you gain a specially cut gemstone and can use it to craft a fabrial. The first time you attempt to craft a fabrial with this gem, you ignore the usual time requirements for attracting a spren and crafting the fabrial, though you still need raw materials. This gem fulfills the gem requirement for a unique fabrial with a tier equal to your current character tier. If you lose it, you can usually find an appropriate replacement after a long rest. During downtime, you can salvage your fabrial to recover this gem.',
      ...
      otherEffects: [
        'Gain gemstone for unique fabrial (tier = character tier)',
        'Can salvage fabrial to recover gem',
        'Can replace lost gem after long rest',
      ],
    },
    {
      id: 'deep_study',
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'efficient_engineer' }],
      tier: 2,
      bonuses: [],
      otherEffects: [
        'Erudition grants +1 cultural or utility expertise',
        'Erudition grants +2 cognitive skills (non-surge)',
        'Can reassign like other Erudition benefits',
      ],
    },
    {
      id: 'fine_handiwork',
    ...
    },
    {
      ...
      bonuses: [],
      otherEffects: [
        'When crafting fabrial with Prized Acquisition gem, can select effect 1 tier higher',
      ],
    },
    {
      id: 'overcharge',
      ...
      actionGrants: [
        {
          type: 'free-action',
          count: 1,
          restrictedTo: 'Strike with fabrial',
          frequency: 'once-per-round',
        },
      ],
      otherEffects: [
        'Raise stakes on fabrial attack',
        'GM can add drawback until DC 15 Crafting test resolves it',
      ],
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: 'fine_handiwork' }],
      tier: 4,
      bonuses: [
        {
          type: BonusType.SKILL,
      ...
      otherEffects: [
        'Crafting time halved',
        'Forgo long rest to reconfigure Prized Acquisition fabrial',
        'Reconfiguration: no materials needed, no time requirement, same tier or lower',
        "Failed spren trap: old fabrial intact, can't reconfigure until next long rest",
        'Success: old fabrial lost',
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 2,
          trigger: 'when making cognitive or spiritual test',
          frequency: 'unlimited',
        },
      ],
