  ...
  nodes: [
    {
      ...
      name: 'Shard Training',
      description:
        "Once per round, when you use the Strike action to attack with a Shardblade, you can choose a number of additional enemies up to your ranks in the skill you used for that Strike. Each target must be within your Shardblade's reach. Without spending focus, you graze each additional target whose Physical defense is equal to or lower than your Strike's test result. Additionally, when you acquire this talent, gain a specialist expertise in Shardplate, and gain a specialist expertise in either Grandbows, Shardblades, or Warhammers. Finally, while you wear Shardplate, it has 2 additional charges for you.",
      actionCost: ActionCostCode.Special,
      specialActivation:
        'Once per round when using Strike with Shardblade, can target additional enemies',
      prerequisites: [{ type: 'talent', target: 'vigilant_stance' }],
      tier: 1,
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'shardplate_charges',
          value: 2,
          condition: 'while wearing Shardplate',
        },
      ],
      expertiseGrants: [
      ...
      otherEffects: [
        'Once per round: Strike with Shardblade can graze additional targets (up to skill ranks) if Physical defense ≤ test result',
        'Requires access to Shardblade and Shardplate for training',
      ],
    },
    {
      id: 'stonestance',
      name: 'Stonestance',
      description:
        "When you acquire this talent, you learn a new stance, which you can enter as an action: Stonestance. While in this stance, increase your deflect value by 1. Additionally, before an enemy within your melee weapon's reach spends one or more actions to attack one of your allies not in Stonestance, that enemy must spend one additional action.",
      actionCost: 1,
      prerequisites: [{ type: 'talent', target: 'vigilant_stance' }],
      tier: 1,
      bonuses: [
      ...
      otherEffects: [
        'Learn Stonestance (enter as 1 action)',
        'Enemies in reach must spend +1 action to attack non-Stonestance allies',
      ],
    },
    {
      id: 'windstance',
      name: 'Windstance',
      description:
        'When you acquire this talent, you learn a new stance, which you can enter as an action: Windstance. While in this stance, you gain an advantage on Agility tests. Additionally, while there are two or more enemies within your reach, you can use a reaction to gain an action, which you can spend only to Disengage or use an action that includes an attack test targeting one or more of those enemies.',
      actionCost: 1,
      prerequisites: [
      ...
      actionGrants: [
        {
          type: 'reaction',
          count: 1,
          restrictedTo: 'Disengage or attack when 2+ enemies in reach',
          timing: 'always',
          frequency: 'unlimited',
        },
      ],
    ...
    },
    {
      ...
      name: 'Mighty',
      description:
        "When you hit with a weapon or unarmed attack, for each action you used on that attack's action, increase the damage you deal by 1 + your tier.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'stonestance' }],
      tier: 2,
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'damage_per_action',
          formula: '1 + tier',
          condition: 'per action spent on attack',
        },
      ],
    },
    {
      ...
      name: 'Bloodstance',
      description:
        'When you acquire this talent, you learn a new stance, which you can enter as an action: Bloodstance. While in this stance, your Opportunity range for attack tests and physical tests expands by 2, but your Physical, Cognitive, and Spiritual defenses decrease by 2.',
      actionCost: 1,
      prerequisites: [
      ...
      otherEffects: [
        'Learn Bloodstance (enter as 1 action)',
        'In stance: Opportunity range +2 for attack/physical tests',
      ],
    },
    {
      id: 'shattering_blow',
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 2,
          trigger: 'when hitting with melee attack (two-handed or hand free)',
        },
      ],
      otherEffects: [
        'Before damage: armor loses 1 charge',
        'After damage: push target 5 feet (+5 per Strength above 5)',
        'If pushed into object: 1d6 impact per 10 feet pushed',
      ],
    },
    {
      id: 'meteoric_leap',
      ...
      attackDefinition: {
        ...
        conditionalAdvantages: [{ condition: 'wearing Shardplate', value: 1 }],
        specialMechanics: [
      ...
      conditionEffects: [
        {
          ...
          trigger: 'on hit',
          target: 'target',
          details: 'if target Strength < yours',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'when using Precise Parry reaction',
        },
      ],
      grantsDisadvantage: ['athletics_parry_unarmed_vs_non_shardblade'],
      otherEffects: [
        'Reaction before being hit',
        'Unarmed: Athletics test, spend opportunity to disarm',
        'Weapon: Light/Heavy Weaponry test, spend action to destroy non-Invested weapon with Shardblade',
        'DC = attack result, success turns hit to graze',
      ],
    },
  ],
};
