...
const ASHSPREN_BOND_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of flamespren as Radiant Shardplate (see chapter 7).',
...
export const DUSTBRINGER_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    expertiseGrants: [{ type: 'fixed', expertises: ['Abrasion', 'Division'] }],
    otherEffects: [
