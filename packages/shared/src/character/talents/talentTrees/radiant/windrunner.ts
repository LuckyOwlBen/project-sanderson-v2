...
const HONORSPREN_BOND_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      prerequisites: [{ type: 'ideal', target: 'third', value: 3 }],
      tier: 6,
      bonuses: [{ type: BonusType.DERIVED, target: 'max-squires', formula: 'tier * 2' }],
      otherEffects: [
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of windspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
...
export const WINDRUNNER_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    expertiseGrants: [{ type: 'fixed', expertises: ['Adhesion', 'Gravitation'] }],
    otherEffects: [
