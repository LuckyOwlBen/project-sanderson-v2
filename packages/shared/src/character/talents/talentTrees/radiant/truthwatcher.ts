  ...
  nodes: [
    {
      ...
      description:
        'You mix Illumination and Regrowth to skillfully repair the mind and soul. Before you restore health to yourself or a willing ally, you can spend 2 Investiture to instead cause the target to recover half as much focus (rounded up) as they would have recovered health.',
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of concentrationspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
...
const FUTURE_SIGHT_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        "You have vague visions of future possibilities, giving you some sway to divert your Fortune. Once per round after you roll the dice for a test, you can spend 1 Investiture or more to reroll that many of the test's dice. The original rolls have no effect and you must use the new result.",
      actionCost: ActionCostCode.Special,
    ...
    },
    {
      ...
      name: 'Vision Void',
      description:
        "Thanks to your ability to see the future and change its course, you and your nearby allies create a black spot in the future sight of others. You and each ally within your spren bond range are immune to any enemy effect that would reroll or replace the result of any die rolled by you or those allies. Additionally, if you're present in or strongly influencing an event, no enemy can ever see visions of that event, whether they're viewing it as a future event or a past one.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
