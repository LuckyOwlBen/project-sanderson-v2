...
const LIGHTSPREN_BOND_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of joyspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
...
export const WILLSHAPER_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    description:
      'You begin bonding a lightspren, allowing you to breathe in and use Stormlight. You might be aware of this nascent bond, or you might use the powers subconsciously until you get closer to speaking the First Ideal. When you acquire this talent, you gain access to Investiture, beginning with a maximum Investiture of 2 + your Awareness or Presence (whichever is higher). You can now use the Breathe Stormlight, Enhance, and Regenerate actions. Additionally, you gain the goal "Speak the First Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You gain the Cohesion and Transportation surges. You gain an additional skill on your character sheet for the above surges, starting with 1 rank in each.',
    actionCost: ActionCostCode.Special,
    ...
    conditionEffects: [
      ...
      {
        type: 'apply',
        condition: 'Transportation Surge',
        trigger: 'goal-complete',
        target: 'self',
        duration: 'permanent',
      },
    ],
    expertiseGrants: [{ type: 'fixed', expertises: ['Cohesion', 'Transportation'] }],
    otherEffects: [
