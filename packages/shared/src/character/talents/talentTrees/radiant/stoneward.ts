...
import { TalentPath } from '../../talentInterfaces/talentPath';
  ...
  nodes: [
    {
      ...
      description:
        "Stonewards strive to exemplify determination and teamwork. Their resolve shows allies where to intuitively hold the line. After you use the Gain Advantage action while having 1 Investiture or more, whether you succeed or fail, the next test an ally makes against that target gains an advantage. Until the end of your next turn, while standing on stone, you can't be moved against your will or knocked Prone.",
      ...
      actionGrants: [
        {
          type: 'reaction',
          count: 1,
          restrictedTo: 'gain-advantage-vs-target',
      ...
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'forced-movement',
          trigger: 'on-stone',
          target: 'self',
          duration: 'end-of-next-turn',
          details: 'cannot be moved or knocked Prone while on stone',
        },
      ],
      otherEffects: [],
    },
    {
      ...
      name: 'Invested',
      description:
        'You learn to hold and wield greater quantities of Stormlight within yourself. When you acquire this talent, your maximum Investiture increases by a number equal to your tier. When your tier increases by 1, your maximum Investiture does as well.',
      actionCost: ActionCostCode.Passive,
    ...
    },
    {
      ...
      otherEffects: ['Grants goal: Speak the Second Ideal'],
    },
    {
      id: 'stoneward_wound_regeneration',
      name: 'Wound Regeneration',
      description:
        'You can use Stormlight to rapidly recover from injuries. When you use the Regenerate free action, you can spend Investiture to instantly recover from an injury of your choice (either instead of or in addition to healing yourself). Spend 2 Investiture to recover from a temporary injury, or spend 3 Investiture to recover from a permanent one.',
      actionCost: ActionCostCode.Special,
      ...
      resourceTriggers: [
        {
          ...
          frequency: 'unlimited',
          condition: 'heal temporary injury',
        },
        {
          resource: 'investiture',
          effect: 'spend',
          ...
          trigger: 'regenerate-action',
          frequency: 'unlimited',
          condition: 'heal permanent injury',
        },
      ],
      otherEffects: [],
    },
    {
      ...
      description:
        'You seek to advance your Nahel bond even further by speaking the Third Ideal. You gain the goal "Speak the Third Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can summon your spren as a Radiant Shardblade (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
      ...
      otherEffects: ['Grants goal: Speak the Third Ideal', 'Reward: Can summon Radiant Shardblade'],
    },
    {
      id: 'stoneward_deepened_bond',
      name: 'Deepened Bond',
      description:
        'The strength of your Nahel bond now allows your spren to manifest more fully in the Physical Realm. Your spren bond range increases from 30 feet to 100 feet. Additionally, when you spend focus to give your spren a task, it costs you 1 fewer focus (to a minimum cost of 1).',
      actionCost: ActionCostCode.Passive,
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of bindspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
...
export const STONEWARD_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    description:
      'You begin bonding a peakspren, allowing you to breathe in and use Stormlight. You might be aware of this nascent bond, or you might use the powers subconsciously until you get closer to speaking the First Ideal. When you acquire this talent, you gain access to Investiture, beginning with a maximum Investiture of 2 + your Awareness or Presence (whichever is higher). You can now use the Breathe Stormlight, Enhance, and Regenerate actions. Additionally, you gain the goal "Speak the First Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You gain the Cohesion and Tension surges. You gain an additional skill on your character sheet for the above surges, starting with 1 rank in each.',
    actionCost: ActionCostCode.Special,
    ...
    actionGrants: [
      {
        type: 'free-action',
        count: 3,
        restrictedTo: 'Breathe Stormlight, Enhance, Regenerate',
        frequency: 'unlimited',
      },
    ],
    conditionEffects: [
      ...
      {
        type: 'apply',
        condition: 'Tension Surge',
        trigger: 'goal-complete',
        target: 'self',
        duration: 'permanent',
      },
    ],
    expertiseGrants: [{ type: 'fixed', expertises: ['Cohesion', 'Tension'] }],
    otherEffects: [
