...
export const ARCHER_TALENT_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      name: 'Backstep',
      description:
        "After you make a ranged attack, spend 2 focus to Disengage as a free action. If you then end your turn in cover or an area where your enemy's senses are obscured, you gain the benefit of the Brace action.",
    ...
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: 'steady_aim' }],
      tier: 4,
      bonuses: [
        {
