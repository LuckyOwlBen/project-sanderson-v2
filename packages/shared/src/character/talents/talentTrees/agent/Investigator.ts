  ...
  nodes: [
    {
      ...
      prerequisites: [{ type: 'skill', target: 'Deduction', value: 1 }],
      tier: 1,
      bonuses: [],
    ...
    },
    {
      ...
      name: "Get 'Em Talking",
      description:
        "Spend 1 focus to test Deduction vs. Spiritual to learn the target's motivation. During this scene, you cna raise the stakes on tests to leverage this motivation.",
      actionCost: 2, // 2 actions
      prerequisites: [{ type: 'skill', target: 'Insight', value: 2 }],
      tier: 1,
      bonuses: [],
      otherEffects: [
    ...
    },
    {
      ...
      name: 'Quick Analysis',
      description:
        'Spend 2 focus to gain 2 action points for cognitive tests with use as skill, Gain Advantage, or an agent talent.',
      actionCost: 0, // Free
      prerequisites: [{ type: 'talent', target: 'watchfulEye' }],
      tier: 2,
      bonuses: [],
      otherEffects: [
        'Spend 2 focus to gain 2 action points for cognitive tests with use as skill, Gain Advantage, or an agent talent.',
    ...
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: "Get 'Em Talking" }],
      tier: 2,
      bonuses: [],
      otherEffects: [
        'To resist your influence, a character must spend additional focus equal to your tier.',
    ...
    },
    {
      ...
      description:
        'Gain an advantage on cognitive tests against characters whose motiviation you know. You know when those characters lie to you.',
      actionCost: Infinity, // Passive
      prerequisites: [
