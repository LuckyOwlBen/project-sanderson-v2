  ...
  nodes: [
    {
      ...
      description:
        'You possess the innate abilities of a Singer, allowing you to assume various forms during highstorms.',
      actionCost: Infinity,
      prerequisites: [],
      tier: 0,
      bonuses: [],
    },
    {
      ...
      actionCost: 3,
      prerequisites: [{ type: 'talent', target: 'singer_ancestry' }],
      tier: 0,
      bonuses: [],
    },
    {
      ...
      description:
        'Gain artform and nimbleform. These forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
    ...
    },
    {
      ...
      description:
        'Gain meditationform and scholarform. These forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
    ...
    },
    {
      ...
      description:
        'Gain warform and workform. These forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
    ...
    },
    {
      ...
      name: 'Ambitious Mind',
      description:
        'Increase Cognitive defense by 2. You can bond a Voidspren but once per day on a complication you must test Discipline (DC 15) or be Stunned.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
      ...
      tier: 3,
      bonuses: [{ type: BonusType.DEFENSE, target: 'cognitive', value: 2, scaling: false }],
      otherEffects: [
    ...
    },
    {
      ...
      description:
        'Gain direform and stormform. These powerful Voidspren-bonded forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
    ...
    },
    {
      ...
      description:
        'Gain envoyform and relayform. These Voidspren-bonded forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
    ...
    },
    {
      ...
      description:
        'Gain decayform and nightform. These mysterious Voidspren-bonded forms become available to you during highstorms when you use Change Form.',
      actionCost: Infinity,
      prerequisites: [
        { type: 'talent', target: 'singer_ancestry' },
        { type: 'talent', target: 'singer_change_form' },
