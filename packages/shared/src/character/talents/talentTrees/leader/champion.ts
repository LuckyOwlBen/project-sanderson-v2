  ...
  nodes: [
    {
      ...
      description:
        "After you use the Strike action, use Decisive Command as a free action. If your Strike didn't hit, you also don't have to spend the usual focus for Decisive Command.",
    ...
    },
    {
      ...
      otherEffects: [
        'If target resists influence: gain advantage on next test vs them until end of your next turn',
      ],
    },
    {
      id: 'hardy',
      ...
      prerequisites: [{ type: 'talent', target: 'valiant_intervention' }],
      tier: 2,
      bonuses: [
        {
    ...
    },
    {
      ...
      name: 'Resolute Stand',
      description:
        "When you use your Valiant Intervention, you can spend focus up to your ranks in Leadership to target that many additional characters. Additionally, after you affect a target with Valiant Intervention, they can't make Reactive Strikes against your allies until the end of that target's next turn.",
      actionCost: ActionCostCode.Special,
      specialActivation:
        'Enhances Valiant Intervention with multi-target and Reactive Strike prevention',
      prerequisites: [
        { type: 'skill', target: 'athletics', value: 1 },
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'imposing_posture' }],
      tier: 3,
      bonuses: [],
    ...
    },
    {
      ...
      description:
        'Before you make an Athletics, Agility, or Leadership test, you can spend 1 focus to roll your command die and add the result to your d20 roll. Additionally, when you acquire this talent, increase the size of your command die by one size (such as from a d4 to a d6).',
      actionCost: ActionCostCode.Special,
