...
export const OFFICER_TALENT_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        'Choose an ally you can influence within 20 feet of you. Before the end of your turn, they can use the Disengage or Gain Advantage action as a reaction.',
      actionCost: 1,
      prerequisites: [
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'through_the_fray' }],
      tier: 2,
      bonuses: [
        {
    ...
    },
    {
      ...
      name: 'Well Supplied',
      description:
        'When you make a test to requisition or allocate resources, you can spend 2 focus to add an Opportunity to the result. Additionally, when you acquire this talent, gain a utility expertise in Military Logistics.',
    ...
    },
    {
      ...
      description:
        'Before you make an Intimidation, Leadership, or Persuasion test, you can spend 1 focus to roll your command die and add the result to your d20 roll. Additionally, when you acquire this talent, increase the size of your command die by one size (such as from a d4 to a d6).',
      actionCost: ActionCostCode.Special,
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'confident_command' }],
      tier: 4,
      bonuses: [],
      ...
      actionGrants: [
        {
          ...
          restrictedTo:
            'Strike against target enemy only (does not count against Strike action limit)',
        },
      ],
      otherEffects: [
        'Test Leadership vs Cognitive defense',
        'Success: choose up to Leadership rank allies',
        'Failure: choose 1 ally',
      ],
    },
  ],
};
