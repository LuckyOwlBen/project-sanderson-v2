...
import { TalentTree } from '../../talentInterfaces/talentTree';
...
export const TRANSPORTATION_SURGE_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        'You can see greater distances into Shadesmar, and you can use it to orient yourself. When you peer into the Cognitive Realm with Transportation, you can spot things up to a distance equal to 3 × your spren bond range. Additionally, while you have 1 Investiture or more, you always know both which direction is north and which direction you must travel to reach the nearest settlement or gathering of people.',
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'cognitive-realm-sight',
          formula: '3 * spren-bond-range',
          scaling: false,
          condition: 'See into Cognitive Realm extended distance',
        },
      ],
      resourceTriggers: [],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'direction-sense',
          trigger: 'investiture-active',
          target: 'self',
          duration: 'while-invested',
          details: 'Always know north and direction to nearest settlement',
        },
      ],
    },
    {
      ...
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'hit',
          trigger: 'transportation-test-success',
          target: 'self',
          duration: 'immediate',
        },
      ],
      movementEffects: [
        {
          ...
          condition: 'Reaction before being hit; momentarily shift to Cognitive Realm and back',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          ...
          value: 0,
          scaling: false,
          condition: 'Enemy gains disadvantage on next test against you/allies',
        },
      ],
      resourceTriggers: [],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'intent-revealed',
          trigger: 'transportation-test-success',
          target: 'target',
          duration: 'until-next-action',
          details: 'Extrapolate enemy intentions based on spren',
        },
        {
          type: 'apply',
          condition: 'objects-located',
          trigger: 'cognitive-vision-use',
          target: 'self',
          duration: 'instantaneous',
          details: 'Reveal locations of nearby objects',
        },
      ],
    },
    {
      ...
      name: 'Realmic Step',
      description:
        "You briefly slip into the Cognitive Realm, run a short distance there, then reappear in the Physical Realm. Make a DC 15 Transportation test. On a success, spend 2 Investiture to move through Shadesmar (along with each object you're wearing or carrying), transporting yourself to an unoccupied space you can sense within your spren bond range. This movement doesn't trigger Reactive Strikes. If you are on or above a large body of water, using this talent only costs 1 Investiture, as you don't have to shape the sea of beads beneath yourself to move around.",
      actionCost: 1,
      prerequisites: [
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'teleportation-range',
          formula: 'spren-bond-range',
          scaling: false,
          condition: 'Teleport within spren bond range',
        },
      ],
      resourceTriggers: [
        {
      ...
      movementEffects: [
        {
          type: 'teleport',
          amount: 0,
          timing: 'as-part-of-action',
          condition:
            'within-spren-bond-range; move through Shadesmar without triggering Reactive Strikes',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'physical-to-cognitive',
          frequency: 'once-per-round',
          condition: 'no-test-required',
        },
        {
          resource: 'investiture',
          effect: 'spend',
          amount: 2,
          trigger: 'cognitive-to-physical',
          frequency: 'once-per-round',
          condition: 'dc-20-test-success',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'realm-crossed',
          trigger: 'elsecalling-activation',
          target: 'self',
          duration: 'instant',
          details: 'Transport self and equipment to same location in opposite realm',
        },
      ],
      movementEffects: [
        {
          ...
          amount: 0,
          timing: 'as-part-of-action',
          condition: 'perpendicularity-opened; movement does not trigger Reactive Strikes',
        },
      ],
    },
    {
      ...
      description:
        "You can keep your miniature perpendicularities open long enough to bring others along. When you move yourself through Shadesmar with your Elsecalling or Realmic Step talent, you can spend additional Investiture to also transport willing characters within your reach, along with everything they're wearing or carrying. Spend 1 Investiture per additional character you choose to transport.",
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'transport-additional-character',
          frequency: 'once-per-round',
          condition: 'within-reach-willing',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'transported-with-group',
          trigger: 'elsecalling-or-realmic-step-use',
          target: 'all-allies',
          duration: 'instant',
          details: 'Transport allies within reach along with self and equipment',
        },
      ],
      movementEffects: [
        {
          ...
          amount: 0,
          timing: 'as-part-of-action',
          condition: 'allies-in-reach; transport willing characters',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 0,
          trigger: 'elsegate-activation',
          frequency: 'once-per-scene',
          condition: 'requires-infused-spheres-2x-character-count',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'long-distance-transported',
          trigger: 'elsegate-activation',
          target: 'all-allies',
          duration: 'instant',
          details: 'Transport up to 10 willing allies to known Oathgate/perpendicularity',
        },
      ],
      movementEffects: [
        {
          ...
          timing: 'as-part-of-action',
          condition:
            'after-long-rest-known-destination; transport with equipment to visited location',
        },
      ],
    },
    {
      ...
      name: 'Realmwalker',
      description:
        'You effortlessly step between the Cognitive and Physical Realms. When you make a Transportation test to use a Transportation talent, you automatically succeed.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
        { type: 'talent', target: 'transportation_elsecalling' },
        { type: 'skill', target: 'TRANSPORTATION', value: 4 },
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'transportation-talent-tests',
          value: 0,
          scaling: false,
          condition: 'Automatically succeed on Transportation tests for talents',
        },
      ],
      resourceTriggers: [],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'realms-effortless',
          trigger: 'transportation-talent-use',
          target: 'self',
          duration: 'permanent',
          details: 'No need to roll Transportation tests',
        },
      ],
    },
  ],
