  ...
  nodes: [
      ...
      conditionEffects: [
        {
          ...
          trigger: 'activation',
          target: 'target',
          duration: 'investiture-maintained',
          details: 'Two objects within 5 feet stuck together',
        },
      ],
      otherEffects: [
      ...
      conditionEffects: [
        {
          ...
          duration: 'investiture-maintained',
          details:
            'Applies to objects the target is holding or wearing; auto-succeed infusion test',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'adhesion-ended',
          trigger: 'free-action',
          target: 'target',
          duration: 'instant',
          details: 'Recover remaining Investiture within reach',
        },
      ],
    ...
    },
    {
      ...
      name: 'Binding Shot',
      description:
        'You "paint" your ammunition with Adhesion before throwing or firing it at a target, transferring the infusion to one of your target\'s possessions. You can use Binding Strike when you hit with a ranged attack at any distance, and you don\'t need to touch the infused targets or have a hand free.',
      actionCost: ActionCostCode.Special,
      ...
      bonuses: [
        {
          ...
          target: 'adhesion-range',
          condition: 'Can apply Adhesion at any distance',
        },
      ],
      resourceTriggers: [
        {
      ...
      conditionEffects: [
        {
          ...
          target: 'target',
          duration: 'investiture-maintained',
          details: 'Applies to possessions at any distance',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      description:
        "You can infuse targets from a greater distance. You can use your surges and their talents as though your reach is 20 feet, and you don't need to touch the target. (As usual, if you adhere two objects together, they must be within 5 feet of each other.)",
      ...
      tier: 2,
      bonuses: [{ type: BonusType.DERIVED, target: 'reach', value: 20 }],
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'touch-requirement',
          trigger: 'activation',
          target: 'self',
          duration: 'permanent',
          details: 'No touch required for infusion',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      name: 'Adhesive Trap',
      description:
        "You can infuse Adhesion into surfaces, causing anyone who touches them to become stuck. When you use Adhesion, you can choose to infuse no objects, and instead only infuse a portion of one surface, up to the size you can affect with your ranks in Adhesion. When another character touches this infused area, they become subject to a Full Lashing with that surface for the duration of the infusion, and your test to Lash them in this way automatically succeeds. For example, a character becomes Lashed to the surface if they're touching it when you infuse it, if they later touch it while moving through its space, or if they're forcibly moved into its space (such as with a gravitational Lashing).",
      actionCost: ActionCostCode.Special,
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Adhesion Trap',
          trigger: 'contact',
          target: 'all-enemies',
          duration: 'investiture-maintained',
          details: 'Auto-succeed on lash test, triggers on contact or forced movement',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      description:
        'Your Full Lashings use less Stormlight, allowing them to last much longer. When you perform a Full Lashing, instead of the infusion using 1 Investiture per round, it expends 1 Investiture per number of rounds equal to your ranks in Adhesion. For example, if you have 3 ranks in Adhesion, those infusions expend Investiture once every 3 rounds.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          trigger: 'maintenance',
          frequency: 'once-per-round',
          condition: 'Expends per X rounds; X = adhesion-skill-ranks',
        },
      ],
      ...
      conditionEffects: [
        {
          ...
          trigger: 'lashed-to-larger-surface',
          target: 'target',
          duration: 'investiture-maintained',
          details: 'Character becomes Restrained',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      name: 'Superior Bond',
      description:
        'Your Full Lashings can be broken only by the strongest of individuals. When a character attempts to break one of your Full Lashings, if their Strength attribute is lower than or equal to your ranks in Adhesion, you automatically succeed on the opposed test without either of you rolling.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'ADHESION', value: 4 }],
      tier: 4,
      bonuses: [],
      conditionEffects: [
        {
          type: 'immune',
          condition: 'break-adhesion',
          trigger: 'opponent-break-attempt',
          target: 'self',
          duration: 'permanent',
          details: 'Auto-succeed if opponent Strength ≤ Adhesion ranks',
        },
      ],
      otherEffects: [
