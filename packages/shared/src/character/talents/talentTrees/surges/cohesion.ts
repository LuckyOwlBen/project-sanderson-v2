...
export const COHESION_SURGE_TREE: TalentTree = {
  ...
  nodes: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'stone-communion',
          frequency: 'unlimited',
          condition: 'touching stone',
        },
      ],
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Prone',
          trigger: 'on hit with focus spent',
          target: 'target',
      ...
      conditionEffects: [
        {
          ...
          trigger: 'test-success-vs-cognitive-defense',
          target: 'target',
          duration: 'until-escape',
          details: 'Targets sink into ground and resolidify',
        },
      ],
    },
    {
      ...
      movementEffects: [
        {
          ...
          condition: 'Move through stone as difficult terrain while infused',
        },
      ],
    },
    {
      ...
      description:
        'When you touch stone, you can sense and use your Cohesion through it from a much greater distance. You can use your surges and their talents as though your reach is 20 feet, as long as there is a stone surface between you and your target that you can touch.',
    ...
    },
    {
      ...
      description:
        'Your mastery of Cohesion allows you to shape stone with greater precision and control.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
    ...
    },
    {
      ...
      name: 'Flowing Earth',
      description:
        "Shaping stone with Cohesion has become so natural that you can mold the ground beneath your feet as you actively sculpt other stone. After you use Cohesion or spend at least C on one of its talents, you can shape the stone beneath your feet without spending additional Investiture to do so. The stone pushes you up to 5 feet × your ranks in Cohesion, and you can choose to be pushed in any direction, such as rising upward on a pillar. This movement doesn't trigger Reactive Strikes.",
      ...
      movementEffects: [
        {
          type: 'special-movement',
          amount: '5 * COHESION.ranks',
          timing: 'as-part-of-action',
          condition: 'After using Cohesion or spending confidence on its talents',
        },
      ],
    },
    {
