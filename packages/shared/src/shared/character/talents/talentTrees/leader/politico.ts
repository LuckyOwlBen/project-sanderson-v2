...
export const POLITICO_TALENT_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      name: 'Rumormonger',
      description:
        'When you make a test to spread misinformation or gather rumors, you can spend 2 focus to add an Opportunity to the result. Additionally, when you acquire this talent, gain a utility expertise in Scandal.',
      actionCost: ActionCostCode.Special,
      specialActivation: 'When making test to spread misinformation or gather rumors',
      prerequisites: [{ type: 'talent', target: 'cutthroat_tactics' }],
      tier: 2,
      bonuses: [],
      resourceTriggers: [
        {
    ...
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: 'rumormonger' }],
      tier: 2,
      bonuses: [
        {
    ...
    },
    {
      ...
      name: 'Shrewd Command',
      description:
        'Before you make a Deception, Insight, or Leadership test, you can spend 1 focus to roll your command die and add the result to your d20 roll. Additionally, when you acquire this talent, increase the size of your command die by one size (such as from a d4 to a d6).',
      actionCost: ActionCostCode.Special,
    ...
    },
    {
      ...
      description:
        'Spend 3 focus to make a DC 15 Deception test. On a success, choose a detail you established since the start of the last scene and reveal that it was actually a ruse. This ruse must be plausible. The GM is the final arbiter of what sort of ruse you can reveal.',
      actionCost: 3,
      prerequisites: [
