  ...
  nodes: [
    {
      ...
      name: 'Sure Outcome',
      description:
        'When you use Opportunist, spend 2 focus to change an opportunity to 4 consequences, or change any consequence to an opportunity.',
    ...
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: 'sureOutcome' }],
      tier: 2,
      bonuses: [
    ...
    },
    {
      ...
      actionCost: Infinity, // Passive
      prerequisites: [{ type: 'talent', target: 'plasibleExcuse' }],
      tier: 2,
      bonuses: [],
    ...
    },
    {
      ...
      name: 'Mighty',
      description:
        'When you hit with a weapon or unarmed attack, for each action point spent deal extra damage equal to 1 + your tier.',
      actionCost: Infinity, // Passive
      prerequisites: [{ type: 'talent', target: 'coverStory' }],
      tier: 3,
      bonuses: [],
      otherEffects: [
        'When you hit with a weapon or unarmed attack, for each action point spent deal extra damage equal to 1 + your tier.',
    ...
    },
    {
      ...
      description:
        'Gain High Society expertise. Spend 2 focus to add a opportunity to a test to interact in high society.',
      actionCost: -2, // Special
      specialActivation:
        'Spend 2 focus to add a opportunity to a test to interact in high society.',
      prerequisites: [{ type: 'talent', target: 'coverStory' }],
      tier: 4,
      bonuses: [],
    },
    {
      ...
      prerequisites: [{ type: 'talent', target: 'subtleTakedown' }],
      tier: 4,
      bonuses: [],
    },
  ],
