...
export const THIEF_TALENT_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      name: 'Double Down',
      description:
        'You can reroll again with Opportunist, but on a complication, you lose 2 focus.',
    ...
    },
    {
      ...
      name: 'Surefooted',
      description:
        'Your movement increases by 10. Reduce Damage from falling and dnagerous terrain by twice your tier.',
      actionCost: Infinity, // Passive
      prerequisites: [{ type: 'talent', target: 'cheapShot' }],
      tier: 2,
      bonuses: [],
    },
    {
      ...
      description:
        'Gain Criminal Groups expertise. Spend 2 focus to add an opportunity to a social test against criminals.',
      actionCost: -2, // Special
      specialActivation: 'Spend 2 focus to add an opportunity to a social test against criminals.',
      prerequisites: [{ type: 'talent', target: 'doubleDown' }],
      tier: 3,
      bonuses: [],
    },
    {
    ...
    },
    {
      ...
      actionCost: 0, // Free
      prerequisites: [{ type: 'talent', target: 'surefooted' }],
      tier: 4,
      bonuses: [],
      otherEffects: [
        'Spend 2 focus to gain two actions for physical tests with Use a Skill, gain advantage, or an agent talent.',
