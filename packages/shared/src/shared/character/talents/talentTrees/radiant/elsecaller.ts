  ...
  nodes: [
    {
      ...
      description:
        'Your shrewd reasoning and enhanced observations across realms allow you to notice details others overlook and to react with supernatural alacrity. While you have 1 Investiture or more, you gain an advantage on Deduction tests, on tests you make as part of a reaction, and on tests to gather information while peering between the Physical and Cognitive Realms.',
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You gain the goal "Speak the Fourth Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of logicspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation: 'Upon acquiring this talent',
      prerequisites: [
...
export const ELSECALLER_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    conditionEffects: [
      ...
      {
        type: 'apply',
        condition: 'Transformation Surge',
        trigger: 'goal-complete',
        target: 'self',
        duration: 'permanent',
      },
    ...
    expertiseGrants: [{ type: 'fixed', expertises: ['Transformation', 'Transportation'] }],
    otherEffects: [
