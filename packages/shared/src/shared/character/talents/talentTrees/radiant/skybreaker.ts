  ...
  nodes: [
    {
      ...
      description:
        'You excel at using Division while sweeping through the air with Gravitation. After you Move while maintaining a Basic Lashing on yourself with your Gravitation surge, spend 1 focus to gain an action, which can be used only for Division or one of its talents.',
    ...
    },
    {
      ...
      description:
        'You seek to become a full Knight Radiant by speaking the Fourth Ideal. You immediately speak the Fourth Ideal and must decide on a suitable quest in line with your values. You gain the goal "Complete Your Fourth Ideal Quest." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You can call a swarm of luckspren as Radiant Shardplate (see chapter 7).',
      actionCost: ActionCostCode.Special,
      specialActivation:
        'Upon acquiring this talent, immediately speak Fourth Ideal and choose quest',
      prerequisites: [
...
export const SKYBREAKER_TALENT_TREE: TalentPath = {
  ...
  tierZeroTalent: {
    ...
    description:
      'You begin bonding a highspren, allowing you to breathe in and use Stormlight. You might be aware of this nascent bond, or you might use the powers subconsciously until you get closer to speaking the First Ideal. When you acquire this talent, you gain access to Investiture, beginning with a maximum Investiture of 2 + your Awareness or Presence (whichever is higher). You can now use the Breathe Stormlight, Enhance, and Regenerate actions. Additionally, you gain the goal "Speak the First Ideal." After you complete this goal, you gain the following reward: You become Empowered until the end of that scene. You gain the Division and Gravitation surges. You gain an additional skill on your character sheet for the above surges, starting with 1 rank in each.',
    actionCost: ActionCostCode.Special,
    ...
    conditionEffects: [
      ...
      {
        type: 'apply',
        condition: 'Gravitation Surge',
        trigger: 'goal-complete',
        target: 'self',
        duration: 'permanent',
      },
    ],
    expertiseGrants: [{ type: 'fixed', expertises: ['Division', 'Gravitation'] }],
    otherEffects: [
