  ...
  nodes: [
    {
      ...
      description:
        'Move up to half your movement rate, ignoring difficult terrain, then gain an action that can be spent only on the Brace or Gain Advantage actions.',
      actionCost: 2,
      prerequisites: [
      ...
      movementEffects: [
        {
          ...
          condition: 'ignore difficult terrain',
      ...
      actionGrants: [
        {
          type: 'action',
          count: 1,
          restrictedTo: 'Brace or Gain Advantage only',
          timing: 'always',
        },
      ],
    },
    {
      ...
      description:
        'Once per round, when you miss on a weapon attack, you can graze one target without spending focus. Additionally, when you acquire this talent, gain a weapon expertise and an armor expertise of your choice, and gain a cultural expertise in Military Life.',
    ...
    },
    {
      ...
      description:
        "The Brace action adds two disadvantages to attacks against you, instead of one. Additionally, while you're using a shield to Brace, allies within 5 feet of you can Brace as if they had cover or a shield.",
      ...
      bonuses: [],
      otherEffects: [
        'Brace adds 2 disadvantages instead of 1',
        'When Bracing with shield, allies within 5 feet can Brace as if they had cover/shield',
      ],
    },
    {
      id: 'devastating_blow',
    ...
    },
    {
      ...
      bonuses: [],
      otherEffects: [
        'Allies within 10 feet using Brace also gain your Defensive Position benefits',
      ],
    },
    {
      id: 'hardy',
      name: 'Hardy',
      description:
        'When you acquire this talent, your maximum and current health increase by 1 per level. This applies to all previous and future levels.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'combat_training' }],
      tier: 3,
      bonuses: [
        {
          ...
          value: 1,
          scaling: true,
          condition: 'per level (retroactive)',
        },
      ],
    },
    {
      ...
      actionCost: 1,
      prerequisites: [{ type: 'talent', target: 'hardy' }],
      tier: 4,
      bonuses: [],
      attackDefinition: {
        weaponType: 'any',
      ...
      resourceTriggers: [
        {
          ...
          trigger: 'when resisting influence or losing focus involuntarily',
          condition: 'minimum 1 focus lost',
        },
      ],
    },
  ],
