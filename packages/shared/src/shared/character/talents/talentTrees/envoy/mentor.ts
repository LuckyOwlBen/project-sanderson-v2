  ...
  nodes: [
    {
      ...
      description:
        'After you succeed on a test to attack or Gain Advantage, you can use your Rousing Presence as a free action.',
    ...
    },
    {
      ...
      name: 'Sound Advice',
      description:
        'After an ally you can influence fails a skill test, you can spend 1 focus to use your Rousing Presence on them as a free action.',
      actionCost: ActionCostCode.Reaction,
      prerequisites: [{ type: 'talent', target: 'rousing_presence' }],
      tier: 1,
      bonuses: [],
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'after allied skill test failure',
          frequency: 'unlimited',
        },
      ],
      actionGrants: [
    ...
    },
    {
      ...
      description:
        'After you use your Rousing Presence, the target recovers 1 focus. Additionally, when you acquire this talent, gain a utility expertise in Motivational Speech.',
      ...
      otherEffects: [
        'After using Rousing Presence, target recovers 1 focus',
        'Gain Motivational Speech utility expertise',
      ],
    },
    {
      id: 'mighty',
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'practical_demonstration' }],
      tier: 2,
      bonuses: [],
      otherEffects: [
        'When hitting with weapon/unarmed attack, each action spent increases damage by 1 + tier',
      ],
    },
    {
      ...
      specialActivation:
        'Requires having a companion. When you use your Rousing Presence, instead of the target becoming Determined, you can make them Focused until the end of the scene.',
      prerequisites: [{ type: 'talent', target: 'lessons_in_patience' }],
      tier: 3,
      bonuses: [],
    },
    {
      ...
      bonuses: [],
      otherEffects: [
        'After successful Gain Advantage test, ally within 10 feet gains advantage on next test against target',
      ],
    },
    {
      id: 'foresight',
      name: 'Foresight',
      description:
        'At the beginning of combat and at the start of each of your turns, gain an additional reaction.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
    ...
    },
    {
      ...
      bonuses: [],
      otherEffects: [
        'Can target Unconscious ally with Rousing Presence',
        'If at 0 health, ally rolls recovery die and recovers health equal to result + Leadership ranks',
      ],
    },
  ],
};
