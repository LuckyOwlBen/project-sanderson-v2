  ...
  nodes: [
    {
      ...
      prerequisites: [{ type: 'skill', target: 'discipline', value: 1 }],
      tier: 1,
      bonuses: [],
      resourceTriggers: [
        {
      ...
      conditionEffects: [
        {
          ...
          trigger: 'on success vs Spiritual defense',
          target: 'target',
    ...
    },
    {
      ...
      specialActivation:
        'Costs 1 focus to pacify Disoriented target. Resisting costs additional focus equal to Discipline ranks.',
      tier: 2,
      bonuses: [],
    },
    {
      ...
      conditionEffects: [
        {
          ...
          trigger: 'when all non-minion enemies pacified',
          target: 'self',
          duration: 'immediate',
        },
      ],
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Special,
      prerequisites: [{ type: 'talent', target: 'steadfast_challenge' }],
      specialActivation:
        'While wearing Presentable armor or fashionable clothing, gain an advantage on your first Deception, Leadership, or Persuasion test.',
      tier: 2,
      bonuses: [],
    ...
    },
    {
      ...
      description:
        'Gain High Society expertise. Spend 2 focus to add additional effects to a test to interact in high society.',
      actionCost: 1,
      prerequisites: [{ type: 'talent', target: 'well_dressed' }],
      tier: 2,
      bonuses: [],
      expertiseGrants: [{ type: 'fixed', expertises: ['High Society'] }],
      resourceTriggers: [
        {
          resource: 'focus',
          effect: 'spend',
          amount: 2,
          trigger: 'to add additional effects in high society interactions',
          frequency: 'unlimited',
        },
      ],
    },
    {
      ...
      actionCost: ActionCostCode.Special,
      specialActivation:
        'Spend focus up to Persuasion ranks to add additional targets to Rousing Presence or Steadfast Challenge.',
      prerequisites: [
      ...
      resourceTriggers: [
        {
          resource: 'focus',
          effect: 'spend',
          amount: 'persuasion_ranks',
          trigger: 'when using Rousing Presence or Steadfast Challenge',
          frequency: 'unlimited',
          condition: 'to add additional targets (max = Persuasion ranks)',
        },
      ],
    },
  ],
