...
export const FAITHFUL_TALENT_TREE: TalentTree = {
  ...
  nodes: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'recover',
          amount: 'recovery_die',
          trigger: 'when target uses this talent',
      ...
      resourceTriggers: [
        {
          resource: 'focus',
          effect: 'recover',
          amount: 'half_lore_ranks_rounded_up',
          trigger: 'when you cause focus recovery',
          frequency: 'unlimited',
        },
      ],
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'galvanize' }],
      tier: 2,
      bonuses: [],
      resourceTriggers: [
        {
    ...
    },
    {
      ...
      specialActivation:
        'Spend 1 focus per target to remove Prone, Slowed, Stunned, or Surprised conditions when using Rousing Presence.',
      prerequisites: [
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Special,
      specialActivation:
        'After ally uses Determined condition for Opportunity, choose up to Discipline rank allies to recover 1 focus each',
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'recover',
          amount: 1,
          trigger: 'after allied Determined condition is used',
          frequency: 'unlimited',
          condition: 'up to Discipline rank allies',
        },
      ],
    },
    {
      ...
      actionCost: ActionCostCode.Special,
      specialActivation:
        'After using Aid reaction, spend 1 focus to grant ally Rousing Presence benefits',
      prerequisites: [
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Special,
      specialActivation:
        "When using Rousing Presence, spend 1 focus to increase target's defense by 2 until end of next round",
      prerequisites: [
        { type: 'skill', target: 'discipline', value: 2 },
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'when using Rousing Presence',
          frequency: 'unlimited',
          condition: 'to increase a target defense by 2 until end of next round',
        },
      ],
    },
  ],
