  ...
  nodes: [
    {
      ...
      description:
        "When you acquire this talent, your Erudition talent grants you an additional skill, and you can use Erudition to choose spiritual skills that aren't surges. Additionally, you gain a utility expertise in Diagnosis.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'education' }],
      tier: 1,
      bonuses: [],
      expertiseGrants: [{ type: 'fixed', expertises: ['Diagnosis'] }],
      otherEffects: [
        'Erudition grants +1 skill',
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'when using this action',
          frequency: 'unlimited',
        },
      ],
      conditionEffects: [
        {
          ...
          trigger: 'when treating self',
          target: 'self',
          duration: 'until Medicine test completes',
        },
      ],
      otherEffects: [
        'Test Medicine DC 15',
        "Roll target's recovery die",
        'Success: recover recovery die + Medicine ranks',
        'Failure: recover recovery die only',
      ],
    },
    {
      ...
      description:
        'When you hit a target of your size or smaller with an unarmed attack, you can spend 1 focus to apply the Exhausted condition to your target. The penalty applied by this condition equals half your ranks in Medicine, rounded up.',
      actionCost: ActionCostCode.Special,
      specialActivation: 'When hitting with unarmed attack against same-size or smaller target',
      prerequisites: [{ type: 'talent', target: 'field_medicine' }],
      tier: 2,
      bonuses: [],
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'when hitting with unarmed attack',
          frequency: 'unlimited',
          condition: 'target is your size or smaller',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Exhausted',
          trigger: 'on hit with unarmed attack',
          target: 'target',
          duration: 'until end of scene',
          details: 'Penalty equals half Medicine ranks (round up)',
        },
      ],
      otherEffects: [],
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'emotional_intelligence' }],
      tier: 2,
      bonuses: [
    ...
    },
    {
      ...
      name: 'Swift Healer',
      description:
        'You can use your Field Medicine as a free action. Additionally, when you acquire this talent, you become more skilled in healing. When you use an ability that restores health to another character, they recover additional health equal to your ranks in Medicine.',
      ...
      otherEffects: [
        'When restoring health to others, they recover additional health equal to Medicine ranks',
      ],
    },
    {
      id: 'applied_medicine',
      ...
      bonuses: [
        {
          ...
          formula: 'lore.ranks',
          condition: 'when restoring health',
        },
      ],
      otherEffects: [],
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'injury-condition-removed',
          trigger: 'when using this talent',
          target: 'target',
          duration: 'permanent',
          details: 'Once per 24 hours remove a condition caused by an injury',
        },
      ],
      otherEffects: [
        'Forgo short/long rest to treat ally',
        'Test Medicine DC 10 (+5 per injury beyond first)',
      ],
    },
    {
      id: 'resuscitation',
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 3,
          trigger: 'when using resuscitation',
          frequency: 'unlimited',
          condition: 'target is Unconscious or died within Medicine rank rounds',
        },
      ],
      conditionEffects: [
        {
          ...
          trigger: 'on successful resuscitation',
          target: 'target',
          duration: 'permanent',
          details: 'Optional; also returns target to life if recently dead',
        },
      ],
