  ...
  nodes: [
    {
      ...
      name: 'Mind and Body',
      description:
        "When you acquire this talent, your Erudition talent grants you an additional skill, and you can use Erudition to choose physical skills that aren't surges. Additionally, gain one weapon expertise of your choice.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'education' }],
      tier: 1,
      bonuses: [],
      expertiseGrants: [{ type: 'choice', options: ['weapon'] }],
      otherEffects: [
      ...
      resourceTriggers: [
        {
          ...
          frequency: 'unlimited',
          condition: 'prevent target reactions against chosen ally',
        },
      ],
      otherEffects: [
        'After Gain Advantage with Erudition skill, ally gains benefit instead of you',
      ],
    },
    {
      id: 'composed',
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'strategize' }],
      tier: 2,
      bonuses: [],
      resourceTriggers: [
        {
          ...
          effect: 'recover',
          amount: 'tier',
          trigger: 'on talent acquisition',
          frequency: 'once-per-scene',
          condition: 'max and current focus increase',
        },
        {
          resource: 'focus',
          effect: 'recover',
          amount: 1,
          trigger: 'when tier increases',
          frequency: 'unlimited',
          condition: 'max and current focus increase',
        },
      ],
      ...
      bonuses: [
        {
          ...
          target: 'physical',
          value: 2,
          condition: 'after round beginning until start of your turn',
        },
        {
          type: BonusType.DEFENSE,
          target: 'cognitive',
    ...
    },
    {
      ...
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'talent', target: 'deep_contemplation' }],
      tier: 3,
      bonuses: [],
      conditionEffects: [
        {
          ...
          trigger: 'after successful Gain Advantage',
          target: 'target',
          duration: 'until end of encounter',
          details: 'on next test unless resisted',
        },
      ],
    },
    {
      ...
      tier: 4,
      bonuses: [],
      actionGrants: [{ type: 'reaction', count: 1, restrictedTo: 'after ally rolls Complication' }],
      resourceTriggers: [
        {
          resource: 'focus',
          effect: 'spend',
          amount: 2,
          trigger: 'when using this reaction',
          frequency: 'unlimited',
        },
      ],
      ...
      actionGrants: [
        {
          type: 'action',
          count: 1,
          restrictedTo: 'you and influenced allies',
          frequency: 'once-per-scene',
        },
      ],
      otherEffects: [
        "Test Deduction vs enemy leader's Cognitive defense",
        'Advantage if took slow turn',
      ],
    },
  ],
};
