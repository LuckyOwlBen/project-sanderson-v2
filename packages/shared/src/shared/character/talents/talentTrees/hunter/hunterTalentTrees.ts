...
export const HUNTER_TALENT_TREES: TalentPath = {
  name: 'Hunter',
  paths: [ARCHER_TALENT_TREE, ASSASSIN_TALENT_TREE, TRACKER_TALENT_TREE],
  tierZeroTalent: {
    id: 'seek_quarry',
    name: 'Seek Quarry',
    description:
    ...
    specialActivation:
      'Choose a character as your quarry. Gain advantage on tests to find, attack, and study them.',
    prerequisites: [],
    tier: 0,
    bonuses: [],
