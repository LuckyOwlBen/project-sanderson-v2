...
export const PROGRESSION_SURGE_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description:
        "You use Regrowth to rapidly recover injuries, including permanent ones and missing body parts. Spend 2 Investiture to cause yourself or a willing character you touch to instantly recover from a temporary injury of the target's choice, or spend 3 Investiture to recover from a permanent injury.",
      actionCost: 2,
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 2,
          trigger: 'temporary-injury-recovery',
          frequency: 'unlimited',
        },
        {
          resource: 'investiture',
          effect: 'spend',
          amount: 3,
          trigger: 'permanent-injury-recovery',
          frequency: 'unlimited',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'temporary-injury-removed',
          trigger: 'on-spend-2-investiture',
          target: 'target',
          duration: 'instant',
          details: 'Affects self or touched willing target',
        },
        {
          type: 'apply',
          condition: 'permanent-injury-removed',
          trigger: 'on-spend-3-investiture',
          target: 'target',
          duration: 'instant',
          details: 'Affects self or touched willing target',
        },
      ...
      bonuses: [
        {
          ...
          target: 'explosive-growth-attack',
          formula: '2d4 base, +1 die size per rank',
          scaling: true,
          condition: 'Damage die scales with Progression ranks',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'area-attack-activation',
          condition: 'per activation',
        },
        {
          resource: 'focus',
          effect: 'spend',
          amount: 1,
          trigger: 'immobilize-enhancement',
          condition: 'per hit (optional)',
        },
      ],
      conditionEffects: [
        {
          ...
          trigger: 'attack-hit-with-focus-spent',
          target: 'target',
          duration: 'end-of-next-turn',
          details: 'Applies to targets hit by Explosive Growth when focus spent',
        },
      ],
      movementEffects: [
        {
          ...
          timing: 'always',
          condition: 'Immobilized targets cannot move',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'regeneration-healing',
          formula: '1d6 base, +1 die size per rank',
          scaling: true,
          condition: 'Regenerate healing die scales with ranks',
        },
        {
          type: BonusType.DERIVED,
          target: 'injury-rolls',
          formula: 'progression-modifier',
          scaling: false,
          condition: 'with 1+ Investiture',
        },
      ],
      resourceTriggers: [
        {
          ...
          condition: '1+ investiture',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'enhanced-injury-resistance',
          trigger: 'investiture-active',
          target: 'all-allies',
          duration: 'while-invested',
          details: 'Applies to self and characters infused with Regrowth',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'plant-overgrowth',
          formula: '2d4 base, +1 die size per rank',
          scaling: true,
          condition: 'Plant health increase scales with ranks',
        },
      ],
      resourceTriggers: [],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'overgrown',
          trigger: 'progression-test-success-dc-15',
          target: 'target',
          duration: 'permanent',
          details: 'Applies to plant target',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          trigger: 'regrowth-maintenance',
          frequency: 'once-per-round',
          condition: 'X = progression-ranks',
        },
      ],
      conditionEffects: [],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'progression-scaled-dice',
          formula: 'progression-ranks',
          scaling: false,
          condition: 'Minimum die result equals Progression ranks',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'reliable-rolls',
          trigger: 'low-roll-on-progression-die',
          target: 'self',
          duration: 'instant',
          details: 'Set low die results to Progression ranks minimum',
        },
      ],
    },
    {
      ...
      name: 'From the Brink',
      description:
        'You use Regrowth to pull someone back from the very edge of death. Spend 3 Investiture and touch the body of a character who died within the last minute. If the target is willing, they return to life Unconscious with 0 health.',
      actionCost: 3,
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          frequency: 'unlimited',
          condition: 'target-died-within-1-minute',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'resurrection-complete',
          trigger: 'action-completion',
          target: 'target',
          duration: 'instant',
          details: 'Removes Dead from a recently deceased willing character',
        },
        {
          type: 'apply',
          condition: 'Unconscious',
          trigger: 'resurrection-completion',
          target: 'target',
          duration: 'until-healed',
          details: 'Applies to resurrected character',
        },
      ],
    },
    {
      ...
      name: 'Font of Life',
      description:
        "You've grown so powerful that growth and healing flow from you with incredible speed. It costs you one C fewer to use Progression and its talents.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'PROGRESSION', value: 4 }],
      tier: 4,
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'progression-talents',
          value: -1,
          scaling: false,
          condition: 'Progression talents cost 1 fewer focus',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'reduce-cost',
          amount: 1,
          trigger: 'progression-talent-activation',
          frequency: 'unlimited',
        },
      ],
      conditionEffects: [],
