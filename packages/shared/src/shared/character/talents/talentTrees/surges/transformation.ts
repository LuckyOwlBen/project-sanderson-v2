  ...
  nodes: [
    ...
    },
    {
      ...
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'projectile-hit',
          trigger: 'transformation-test-success',
          target: 'self',
          duration: 'immediate',
          details: 'May apply to ally within reach',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          ...
          target: 'living-soulcasting-attack',
          formula: '3d4 base, +1 die size per rank',
          scaling: true,
          condition: '3d4 (rank1), 3d6 (rank2), 3d8 (rank3)',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'living-soulcast-attack',
          frequency: 'once-per-round',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'transformation-on-death',
          trigger: 'attack-reduces-to-zero-health',
          target: 'target',
          duration: 'permanent',
          details: 'Applies to defeated target',
        },
      ],
    },
    {
      ...
      name: 'Soulcast Parry',
      description:
        'You can use Soulcasting to defend against even more immediate threats. You can now use Soulcast Defense on melee weapon attacks as well as ranged ones.',
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'soulcast-defense-capability',
          trigger: 'melee-attack',
          target: 'self',
          details:
            'Can use Soulcast Defense on melee weapon attacks; may protect ally within reach',
        },
      ],
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'poison-removed',
          trigger: 'transformation-test-success-dc-15',
          target: 'target',
          duration: 'instant',
          details: 'Remove poison on success',
        },
        {
          type: 'apply',
          condition: 'injury-recovery-reduced',
          trigger: 'transformation-test-success',
          target: 'target',
          duration: 'scene',
          details: 'Reduce recovery time of one injury by 5 days',
        },
      ],
    },
    {
      ...
      description:
        "You can Soulcast from a greater distance. You can use your surges and their talents as though your reach is 20 feet, and you don't need to touch the target.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'all-surge-talents-reach',
          value: 20,
          scaling: false,
          condition: 'Use surges at 20-foot reach without touch',
        },
      ],
      movementEffects: [
        {
          ...
          amount: 20,
          timing: 'always',
          condition: 'Use surges/talents with 20 ft reach without touch',
        },
      ],
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'flame-category-gain',
          trigger: 'passive',
          target: 'self',
          duration: 'permanent',
          details: 'Gain sixth Soulcasting category: Flame (DC 30 for 5-step transformation)',
        },
        {
          type: 'apply',
          condition: 'ignitable',
          trigger: 'soulcast-to-flame',
          target: 'target',
          duration: 'until-burned',
          details: 'Affects flammable objects near the Soulcast area',
        },
      ],
      actionGrants: [
        {
          ...
          count: 1,
          timing: 'always',
          restrictedTo: 'area-attack-within-5-feet after soulcast-to-flame',
          frequency: 'once-per-round',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'non-living-transformations',
          value: 15,
          scaling: false,
          condition: 'Maximum DC reduced to 15',
        },
      ],
      resourceTriggers: [
        {
          resource: 'investiture',
          effect: 'spend',
          amount: '1-per-previous-failure',
          trigger: 'reattempt-soulcast',
          frequency: 'once-per-round',
          condition: 'after-failed-attempt-same-scene',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'reattempt-soulcast',
          trigger: 'failed-previous-attempt',
          target: 'self',
          duration: 'scene',
          details: 'Can reattempt failed Soulcasting in same scene; target object same as failure',
        },
      ],
    },
    {
      ...
      description:
        "You've become so powerful that you can Soulcast larger objects with much greater efficiency. When you Soulcast non-living material, reduce the Investiture cost by 2 (to a minimum of 1 Investiture). For example, it now costs you only 1 Investiture to Soulcast either a Small, Medium, or Large object.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'reduce-cost',
          amount: 2,
          trigger: 'non-living-soulcasting',
          frequency: 'once-per-round',
          condition: 'minimum-1-investiture',
        },
      ],
      conditionEffects: [],
    },
