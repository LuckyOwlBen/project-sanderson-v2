...
export const GRAVITATION_SURGE_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      tier: 1,
      bonuses: [{ type: BonusType.DERIVED, target: 'gravitation-rate', value: 40 }],
      resourceTriggers: [
        {
          resource: 'focus',
          effect: 'spend',
          amount: 1,
          trigger: 'melee-attack-during-flight',
          frequency: 'unlimited',
        },
      ],
      movementEffects: [
        {
          ...
          condition: 'Can interrupt flight to make melee attack, then continue',
        },
      ],
      otherEffects: [],
    },
    ...
    },
    {
      ...
      name: 'Stable Flight',
      description:
        "You're an expert in launching attacks from afar in mid-flight. While maintaining a Basic Lashing on yourself, your ranged attacks don't gain a disadvantage due to flying or other causes of unstable footing.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
    ...
    },
    {
      ...
      description:
        'You can apply multiple Basic Lashings to an enemy. After you succeed on a Gravitation test to move an unwilling character, you can infuse them with an amount of Investiture up to your ranks in Gravitation (instead of only 1 Investiture). When you do, the effect continues until the infusion ends (instead of until the start of your next turn).',
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'gravitation-success',
          frequency: 'unlimited',
          condition: 'Spend up to Gravitation ranks on unwilling target',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Multiple Lashings',
          trigger: 'gravitation-success',
          target: 'target',
          duration: 'until-infusion-ends',
          details: 'Effect extends beyond start of next turn',
        },
      ],
      otherEffects: [],
    },
      ...
      resourceTriggers: [
        {
          ...
          trigger: 'activation',
          frequency: 'unlimited',
          condition: 'Spend distance divided by gravitation rate (rounded up)',
        },
      ],
      otherEffects: [
    ...
    },
    {
      ...
      name: 'Group Flight',
      description:
        'You can infuse multiple allies with Gravitation at once. While not in combat, when you spend 1 Investiture or more to infuse yourself or a willing character with a Basic Lashing, you can also infuse a number of additional willing characters up to your ranks in Gravitation. Each target must be within your reach. These infusions last for the duration of the original infusion and require no additional Investiture to create or maintain.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Basic Lashing',
          trigger: 'group-infusion',
          target: 'all-allies',
          duration: 'original-infusion-duration',
          details: 'A number of willing allies up to your Gravitation ranks within reach',
        },
      ],
      otherEffects: ['Only usable while not in combat', 'Each target must be within reach'],
    },
    {
      id: 'gravitation_aerial_squadron',
      name: 'Aerial Squadron',
      description:
        "You've trained your allies in aerial combat scenarios, readying them to fly together at a moment's notice. You can use your Group Flight in combat.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'combat-restriction',
          trigger: 'group-flight',
          target: 'self',
          duration: 'permanent',
          details: 'Can use Group Flight in combat',
        },
      ],
      otherEffects: [],
    },
    {
      ...
      description:
        "You've become so efficient at infusing yourself with Gravitation that it becomes subconscious, allowing you to endlessly soar. While you have 1 Investiture or more, you gain the benefits of being infused with Gravitation without spending Investiture.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'GRAVITATION', value: 4 }],
      tier: 4,
      bonuses: [],
      resourceTriggers: [
        {
          ...
          condition: 'Gain infusion benefits with 1+ Investiture without spending',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Gravitation infusion',
          trigger: 'passive',
          target: 'self',
          duration: 'permanent',
          details: 'Gain benefits without spending Investiture while holding 1+',
        },
      ],
      otherEffects: [],
    },
