  ...
  nodes: [
    ...
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'distracting-illusion-active',
          trigger: 'create-duplicate',
          target: 'all-enemies',
          details: 'Attacks against target have disadvantage and cannot graze',
        },
        {
          type: 'apply',
          condition: 'illusion-ends',
          trigger: 'attack-misses-or-end-of-scene',
          target: 'target',
        },
      ],
      resourceTriggers: [
      ...
      bonuses: [
        {
          ...
          target: 'infusion-range',
          value: 5,
          scaling: false,
          condition: 'Sphere or unencased gem within 5 feet',
        },
      ],
      resourceTriggers: [
        {
          ...
          trigger: 'maintain-illusion',
          frequency: 'unlimited',
          condition: 'X = Illumination ranks',
        },
      ],
      movementEffects: [
    ...
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'illumination-test-success',
          trigger: 'apply-condition',
          target: 'all-enemies',
          details: 'Targets become Disoriented until end of their next turn',
        },
      ],
    },
    {
      ...
      description:
        'You can reclaim Stormlight from active illusions. After your infusions expend their infused Investiture at the start of your turn, you can end any number of those infusions within your reach, recovering all remaining Investiture they were infused with.',
      ...
      resourceTriggers: [
        {
          ...
          frequency: 'unlimited',
          condition: 'infusion within reach',
        },
      ],
    },
    {
      ...
      description:
        'You use Lightweaving to show your allies inspiring possibilities of who they could become. Spend 2 Investiture to create a momentary Lightweaving near an ally you can sense within your spren bond range. That ally becomes Determined and Focused until the end of their next turn.',
      actionCost: 1,
      prerequisites: [
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 2,
          trigger: 'create-lightweaving',
          frequency: 'unlimited',
          condition: 'ally within spren bond range',
        },
      ],
      conditionEffects: [
        {
          type: 'apply',
          condition: 'lightweaving-created',
          trigger: 'apply-conditions',
          target: 'target',
          details: 'Ally becomes Determined and Focused until end of their next turn',
        },
      ],
    },
    {
      ...
      description:
        'You effortlessly Lightweave multiple illusions at once. When you Lightweave an illusion, you can create a number of additional illusions up to your ranks in Illumination. These infusions last for the duration of the original infusion and require no additional Investiture to create or maintain.',
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'additional-illusions',
          formula: 'illumination-ranks',
          scaling: true,
          condition: 'Create up to ranks additional illusions',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'reduce-cost',
          amount: 0,
          trigger: 'create-additional-illusions',
          frequency: 'unlimited',
          condition: 'included in original infusion',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 2,
          trigger: 'create-haunting-image',
          frequency: 'unlimited',
          condition: 'target within spren bond range',
        },
        {
          resource: 'focus',
          effect: 'spend',
          ...
          condition: 'X = Illumination ranks, optional action',
        },
      ],
      conditionEffects: [
        {
          ...
          trigger: 'apply-condition',
          target: 'target',
          details: 'Target becomes Slowed until end of their next turn',
        },
      ],
      movementEffects: [
        {
          ...
          condition: 'If focus not spent, forced to move away from caster',
        },
      ],
    },
    {
      ...
      description:
        "You've become so efficient at powering your illusions that you can maintain them indefinitely. While you have 1 Investiture or more, each of your Illumination infusions within your spren bond range expends no infused Investiture at the start of your turn.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'ILLUMINATION', value: 4 }],
      tier: 4,
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'illusion-maintenance',
          value: 0,
          scaling: false,
          condition: 'No Investiture expended within spren bond range while at 1+ Investiture',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'reduce-cost',
          amount: 0,
          trigger: 'maintain-illusions',
          frequency: 'once-per-round',
          condition: 'with 1+ Investiture, within spren bond range',
        },
      ],
    },
  ],
