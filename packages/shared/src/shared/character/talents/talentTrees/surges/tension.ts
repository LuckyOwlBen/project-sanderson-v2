  ...
  nodes: [
    ...
    },
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Hardened Defense',
          trigger: 'before being hit or grazed',
          target: 'all-allies',
          duration: 'until end of trigger',
          details: 'Tension infused: +2 Physical defense, can turn hit to miss or negate graze',
        },
      ],
    },
    {
      ...
      description:
        'You can reclaim Stormlight from active infusions. After your infusions expend their infused Investiture at the start of your turn, you can end any number of those infusions within your reach, recovering all remaining Investiture they were infused with.',
      ...
      resourceTriggers: [
        {
          ...
          effect: 'recover',
          amount: 'all-remaining',
          trigger: 'start-of-turn after infusion expends',
          frequency: 'unlimited',
          condition: 'infusions within reach',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          ...
          value: 10,
          scaling: false,
          condition: 'While holding 10+ foot cloth/rope via Tension',
        },
      ],
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'to increase weapon reach',
          frequency: 'unlimited',
          condition: 'as Free action',
        },
        {
          resource: 'focus',
          effect: 'spend',
          amount: '2 or C',
          trigger: 'after melee hit to use Tension',
          frequency: 'unlimited',
        },
      ],
      actionGrants: [
        {
          ...
          count: 1,
          timing: 'always',
          restrictedTo: 'use Tension after melee hit without action',
          frequency: 'unlimited',
        },
      ],
    },
    {
      ...
      description:
        "Your infusions of Tension expend the Stormlight far less quickly. When you infuse Tension into an object, instead of the infusion expending 1 Investiture per round, it expends 1 Investiture per number of rounds equal to your ranks in Tension. For example, if you have 3 ranks in Tension, those infusions expend Investiture once every 3 rounds. Additionally, while you have 1 Investiture or more, you can maintain Tension infusions on objects you're holding or wearing without either you or the infusion expending Investiture.",
      ...
      resourceTriggers: [
        {
          resource: 'investiture',
          effect: 'reduce-cost',
          amount: '1 per X rounds',
          trigger: 'Tension infusion maintenance',
          frequency: 'unlimited',
          condition: 'X = Tension ranks',
        },
        {
          resource: 'investiture',
          effect: 'reduce-cost',
          amount: 'all',
          trigger: 'maintain infusions on held/worn objects',
          frequency: 'unlimited',
          condition: 'with 1+ Investiture held',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'tension-shaping',
          value: 1,
          scaling: false,
          condition:
            'Automatically reshape Tension objects into elaborate, intricate shapes without extra actions',
        },
      ],
    },
    {
      ...
      description:
        "You use Tension to solidify the surface of liquids into traversable ground. You can use Tension on liquid, affecting an area up to twice the size you can normally affect with your ranks in Tension. For the duration, this liquid's surface tension increases and characters can walk on it like solid ground.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'tension-liquid-area',
          value: 2,
          scaling: false,
          condition: 'Affects 2× normal size',
        },
      ],
      movementEffects: [
        {
          ...
          condition:
            'while Tension surface active; characters can walk on liquid surface like solid ground',
        },
      ],
    },
    {
      ...
      bonuses: [
        {
          type: BonusType.DERIVED,
          target: 'infused-object-health',
          formula: '5 * ranks',
          scaling: true,
          condition: 'Object current/max health = 5 × Tension ranks',
        },
        {
          type: BonusType.DEFENSE,
          target: 'infused-object-all-defenses',
          value: 0,
          scaling: false,
          condition: 'Defenses = 10 + Tension modifier',
        },
        {
          type: BonusType.DERIVED,
          target: 'controlled-object-attack',
          formula: '2d4 base, +1 die size per rank',
          scaling: true,
          condition: '2d4 (rank1), 2d6 (rank2), 2d8 (rank3)',
        },
      ],
      movementEffects: [
        {
          type: 'special-movement',
          amount: 25,
          condition: 'while touching infused object; move along surfaces (including ceilings)',
    ...
    },
    {
      ...
      name: 'Clothsmith',
      description:
        'The impromptu weapons and armor you create with Tension are so powerful that they rival Shardblades and Plate. When you infuse Tension to grant a character the Hardened Defense effect, their Physical defense increases by 4 (instead of 2). Additionally, when you temporarily create a weapon with Tension (see "Creating Objects and Weapons"), it gains an extra d4 damage die (for example, an axe created this way deals 1d6 + 1d4 keen damage). The size of this die increases with your ranks in Tension; at 2 ranks, the extra die becomes a d6 (instead of a d4), and so on.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'TENSION', value: 4 }],
      tier: 4,
      bonuses: [
        {
          type: BonusType.DEFENSE,
          target: 'Hardened Defense',
          value: 4,
          scaling: false,
          condition: 'Physical defense increases by 4 instead of 2',
        },
        {
          type: BonusType.DERIVED,
          target: 'created-weapons-damage',
          formula: 'extra die (1d4 base, +1 die size per rank)',
          scaling: true,
          condition: 'Extra die: 1d4 (rank1), 1d6 (rank2), etc.',
        },
      ],
    },
  ],
