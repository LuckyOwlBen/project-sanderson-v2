...
export const DIVISION_SURGE_TREE: TalentTree = {
  ...
  nodes: [
    ...
    },
    {
      ...
      name: 'Bodily Decay',
      description:
        'You atrophy the bodies of your enemies, inflicting debilitating wounds. When you hit with a Division attack, you can spend C to inflict an injury on one target of that attack.',
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Injury',
          trigger: 'on hit with Division attack',
          target: 'target',
          details: 'Spend confidence to inflict an injury',
        },
      ],
    },
    {
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'remove immobilized/restrained or physical disadvantage',
          frequency: 'unlimited',
          condition: 'Spend 1+ per effect removed',
        },
      ],
      conditionEffects: [],
    },
    {
      ...
      description:
        "You can make anything burn, even materials that are usually nonflammable. When you affect a target with Division, you can spend 1 or more additional Investiture to cause that target to catch fire for a number of rounds equal to the Investiture spent. If you didn't already have to make a Division test when you affected that target (see \"Division Under Pressure\"), you must succeed on one now to do so. For the duration, the target becomes Afflicted, and the area within 5 feet of the target is lit on fire and becomes dangerous terrain. Both effects deal energy damage equal to your Division modifier. At the GM's discretion, the dangerous terrain can spread on subsequent rounds. The target or a character within reach of it can Use a Skill to make an Agility or Athletics test opposed by your Division. If they succeed, the target's Afflicted condition ends early, but the ignited area continues to burn.",
      actionCost: ActionCostCode.Special,
      ...
      resourceTriggers: [
        {
          ...
          effect: 'spend',
          amount: 1,
          trigger: 'ignite target with Division',
          frequency: 'unlimited',
          condition: 'Spend 1+; duration equals Investiture spent',
        },
      ],
      conditionEffects: [
        {
          ...
          trigger: 'on ignite',
          target: 'target',
          duration: 'investiture rounds',
          details:
            'Area within 5 feet burns as dangerous terrain for Division modifier energy damage',
        },
      ],
    },
    {
      ...
      name: 'Spark Sending',
      description:
        'You annihilate your targets from a distance by sending your entropic spark racing through a physical object, creating a chain reaction at its destination. You can use Division and its talents as though your reach is 20 feet, as long as there is a solid surface from you to your target (such as a wall or floor) along which you can send an entropic spark.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'DIVISION', value: 2 }],
      tier: 2,
      bonuses: [],
      movementEffects: [],
    },
      ...
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'Brace',
          trigger: 'against your Division attacks',
          target: 'target',
          details: 'Brace cannot be used to resist your Division attacks',
        },
      ],
    },
    {
      ...
      description:
        'Your Division is especially potent and destructive. When you roll damage for Division or its talents, roll an additional damage die of the same size.',
      actionCost: ActionCostCode.Passive,
      prerequisites: [
    ...
    },
    {
      ...
      description:
        "You've grown so powerful that the ability to destroy everything around you is almost alarmingly easy. It costs you one C fewer to use Division (but not its talents). Additionally, your DCs on the Division Under Pressure table are reduced by 5.",
      actionCost: ActionCostCode.Special,
      specialActivation: 'When using Division',
      prerequisites: [{ type: 'skill', target: 'DIVISION', value: 4 }],
      tier: 4,
      bonuses: [],
      conditionEffects: [],
    },
