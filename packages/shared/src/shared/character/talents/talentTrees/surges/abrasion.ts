  ...
  nodes: [
    {
      ...
      conditionEffects: [
        {
          type: 'apply',
          condition: 'Frictionless',
          trigger: 'activation',
          target: 'target',
          duration: 'investiture-maintained',
          details: 'Object or portion of surface becomes frictionless',
        },
      ],
      movementEffects: [
        {
          ...
          actionCost: 'free',
          condition: 'Spend 2 focus to Move in straight line (skate)',
        },
      ],
    ...
    },
    {
      ...
      description:
        'You become increasingly adept at using Abrasion to glide through your environment. While infused with Abrasion, your movement rate increases by 10 feet, and you ignore the Slowed condition when imposed by difficult terrain, climbing, crawling, and swimming.',
      ...
      movementEffects: [
        {
          ...
          amount: 10,
          timing: 'always',
          condition: 'while infused with Abrasion',
        },
      ],
      conditionEffects: [
        {
          type: 'prevent',
          condition: 'Slowed',
          trigger: 'difficult-terrain-or-movement',
          target: 'self',
          duration: 'permanent',
          details: 'Ignore Slowed from difficult terrain, climbing, crawling, swimming',
        },
      ],
      otherEffects: [],
    },
    ...
    },
    {
      ...
      description:
        "You dynamically skate around the battlefield, easily slipping away from your foes. When you Skate, you aren't restricted to moving in a straight line.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
    ...
    },
    {
      ...
      description:
        "You can infuse targets from a greater distance. You can use your surges and their talents as though your reach is 20 feet, and you don't need to touch the target.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [
      ...
      tier: 2,
      bonuses: [],
      otherEffects: ['Use surges and talents with 20 feet reach', 'No touch required for infusion'],
    },
    {
    ...
    },
    {
      ...
      description:
        "You make yourself so slick that glancing and hasty blows slide right off you. While you are infused with Abrasion, attacks can't graze you and Reactive Strikes against you gain a disadvantage.",
      actionCost: ActionCostCode.Special,
    ...
    },
    {
      ...
      description:
        "You've become so efficient at infusing yourself with Abrasion that it becomes subconscious, allowing you to slip around with effortless grace. While you have 1 Investiture or more, you gain the benefits of being infused with Abrasion without spending Investiture, and it costs you 1 fewer focus to Skate.",
      actionCost: ActionCostCode.Passive,
      prerequisites: [{ type: 'skill', target: 'ABRASION', value: 4 }],
      tier: 4,
      bonuses: [],
      otherEffects: [
